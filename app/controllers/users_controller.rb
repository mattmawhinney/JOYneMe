class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:username, :email, :password, :city, :about, :first_name, :last_name, :avatar_file_name, :avatar_content_type, :avatar_file_size, :avatar_updated_at )
